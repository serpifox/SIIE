              ...
              //  Toast.makeText(getApplicationContext(),""+ja,Toast.LENGTH_LONG).show();
                if(ja.length()>0){
                    ...
                    if("Alumno".equals(tipo)){
                        ...
                        Inicio_Sesion.this.startActivity(intentAlu);
                        ...
                        if("Administrador".equals(puesto)){
                            Intent intentAdmi = new Intent(Inicio_Sesion.this,Menu_Administrador.class);
                            Inicio_Sesion.this.startActivity(intentAdmi);
